...
class GameScene: SKScene, SKPhysicsContactDelegate, GKGameCenterControllerDelegate  {
  ...
  //set up achievements function
  func achievements(){
    //links all achievements from itunes connect to xcode
    let starsLvl1 = GKAchievement.init(identifier: "15Stars")
    let starsLvl2 = GKAchievement.init(identifier: "20Stars")
    let starsLvl3 = GKAchievement.init(identifier: "30Stars")
    let bombKing = GKAchievement.init(identifier: "bombKing")
    let multiplier = GKAchievement.init(identifier: "multiplier")
    let megaScore = GKAchievement.init(identifier: "megaScore")
    
    //if you get 15 stars
    if stars > 14{
      //get starsLvl1 achievement
      starsLvl1.percentComplete = 100.0
    GKAchievement.reportAchievements([starsLvl1], withCompletionHandler: nil)}
    //if you get 20 stars
    if stars > 19{
      //get starsLvl2 achievement
      starsLvl2.percentComplete = 100.0
    GKAchievement.reportAchievements([starsLvl2], withCompletionHandler: nil)}
    //if you get 30 stars
    if stars > 29{
      //get starsLvl3 achievement
        starsLvl3.percentComplete = 100.0
    GKAchievement.reportAchievements([starsLvl3], withCompletionHandler: nil)}
    //if your score is nevative
    if score < 0{
      //get bonkKing achievement
      bombKing.percentComplete = 100.0
      GKAchievement.reportAchievements([bombKing], withCompletionHandler: nil)}
    //if you hit the X8 multiplier
    if multiplyEight {
      //get the miltiplier achievement
    multiplier.percentComplete = 100.0
    GKAchievement.reportAchievements([multiplier], withCompletionHandler: nil)}
    //if you get atleast 3000
    if score > 2999{
      //get megaScore achievement
      megaScore.percentComplete = 100.0
    GKAchievement.reportAchievements([megaScore], withCompletionHandler: nil)}
  }
